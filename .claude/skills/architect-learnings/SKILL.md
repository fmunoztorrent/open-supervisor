...
## Lecciones recientes
- [2026-06-11] ci-cd-and-pre-commit-test-validation — **Lección**: dividir en capas: pre-commit → tests solo de packages afectados; CI → validate (rápido, bloqueante) + e2e (
