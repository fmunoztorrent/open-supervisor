...
- **jest-coverage-directory-relative-to-rootdir-not-project-root** (x2, 2026-06-10) — **Lección**: siempre verificar la ruta real del coverage generado después de configurar Jest. El `coverageDirectory` es
