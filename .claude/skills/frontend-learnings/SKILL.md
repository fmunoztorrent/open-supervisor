...
## Lecciones recientes
- [2026-06-19] rnsvg-yoga-stylesizelength-rn076 — **Lección**: una dependencia con código nativo Fabric (C++) debe casar con la **minor de React Native**, no basta con qu
