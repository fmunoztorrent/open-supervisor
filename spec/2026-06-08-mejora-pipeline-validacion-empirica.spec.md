...
- [ ] Archivo `.opencode/pipeline/validate-empirica.md` con checklists A/B/C/D
- [ ] `close.md` referencia el paso 5b entre QA GREEN y Cierre
- [ ] 4 tipos de checks: A (Mobile UI), B (Endpoints REST), C (SSE/Real-time), D (Infra/Dependencias)
- [ ] Cada check tiene: qué valida, comando, señal de fallo
- [ ] Fallo en cualquier check → pipeline vuelve a QA RED
...
**Criterios de aceptación:**
- [ ] `scripts/extract-learnings.ts` extendido con 3 niveles de promoción
...
- [ ] Nivel 3 (3ª ocurrencia): agrega a "Accionables bloqueantes" en AGENTS.md
- [ ] Paso 7 documentado en `close.md` como extensión del paso 6e
...
**Criterios de aceptación:**
- [ ] `.claude/AGENTS.md` con sección de accionables por agente
- [ ] 22 accionables (A1-A22) asignados a 7 agentes
- [ ] Cada skill de agente incluye sus accionables relevantes
- [ ] `pipeline-enforcer.js` implementa A16 (excepción merge) y A17 (ignorar state.json)
...
- [ ] `.opencode/pipeline/validate-empirica.md` existe con los 4 checklists
- [ ] `.claude/AGENTS.md` existe con 22 accionables
- [ ] `close.md` referencia pasos 5b y 7
- [ ] 7 skills actualizados con sus accionables
- [ ] `extract-learnings.ts` extendido con 3 niveles
- [ ] `pipeline-enforcer.js` con A16 y A17
- [ ] Mini-feature sintética pasa por el pipeline completo (incluyendo 5b)
